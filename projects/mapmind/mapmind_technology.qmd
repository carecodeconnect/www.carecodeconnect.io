...
# Only age/formal_education as category here; map `technology` to 0/1 after dropna
# (assigning int 0/1 into a categorical `technology` column fails on newer pandas)
category_columns = ['age', 'technology', 'formal_education']
for col in ['age', 'formal_education']:
...
survey_clean['technology'] = survey_clean['technology'].map({'Yes': 1, 'No': 0}).astype('int64')
