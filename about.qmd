...
Explore our [blog](blog.qmd) and [projects](projects.qmd) to find out more!

# Recent Projects

- Building robust and reliable LLM/SLM AI assistant to help freelancers find high quality gigs @ [Shoutt International](https://shoutt.ai).

- Automated data analytics, causal inference, and predictive models for enhancing eco-driving behaviours @ [Lightfoot](https://www.lightfoot.co.uk/).

- Built interactive meditation assistant providing personalised guidance using voice and brain signals for enhanced well-being @ [Data Science Retreat](https://www.datascienceretreat.com/).
