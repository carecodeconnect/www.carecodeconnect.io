...
The app is available for use with OpenAI GPT-3.5 or GPT-4 API here: [App with OpenAI](https://user-reviews.streamlit.app/) or with DistilBart here: [App with BART](https://user-reviews.streamlit.app/).
