...
# Jhana: Meditation Teacher (Coming Soon)

This project is an interactive meditation teacher providing personalised voice guidance in deep states of tranquility. It combines cutting-edge open source HuggingFace Transformer architectures for Natural Language Processing (NLP) with insights from Conversation Analysis.

# Job Seeker (Coming Soon)

A tool to automate the process of finding a job.

# Lease Linker (Coming Soon)

A tool to automate the process of finding accommodation.
...
# Wine Review Analyser (Coming Soon)

This project employs pandas, scikit-learn, and sentiment analysis to model wine sales and reviews.
