...
:::notes
This talk is in praise of documentation. By the end, I hope to have convinced you that documentation is a good thing, and that if you want your code to be used, you should document it. I'll explore tools for "literate programming" and share tips for writing well. Writing good documentation is becoming more important in the age of AI. I'm essentially arguing for better scientific research practice in data science in industry.
:::
...
![](../images/enshitification.jpg){width=50% fig-align="center"}
...
:::notes
She goes on to summarise different types of documentation that are relevant to data science workflows. Here, I am directly quoting her recommendations, because I agree with them:
:::
...
:::notes
Nelson's advice, especially her advice for how to use Jupyter notebooks, can be considered advice for "literate programming". Literate programming is perhaps the most commonly recommended *genre* or *style* of computer programming for data science. The term "literate programming" was coined in 1984, by the American computer scientist Donald Knuth, later Professor Emeritus at Stanford University [@knuth1984]. In literate programming, written prose is interspersed with computer code, within the same document, called a "notebook".
Knuth suggests literate programming is "inherently bilingual", because it combines two different genres of writing within the same computer program files: a document formatting language
and a programming language. While the basic technical implementation of literate programming will be familiar to most data scientists, the origins and history of literate programming might be less familar.
:::
...
A "tool for systems programmers, not for high school students or hobbyists", because the programmer needs to be "comfortable dealing with multiple languages simultaneously" [@knuth1984].
...
You render the Quarto document with `quarto render posts/in-praise-of-documentation/index.qmd` on the command line (from the site repository root).


:::notes
At the top of the Quarto document is a YAML section, specifying the configuration of the document.
If you want to execute Python code cells in the document, Quarto uses `IPython` kernels. In this case, that kernel is a `uv` virtual environment called `pydata`.
:::
...
:::notes
While Knuth's literate programming style will be familiar to most data scientists, his original ideas about computer programming might be less known.
...
:::notes
When we build data systems, or do data analysis, we are *writing text*. When we code, we are communicating. We are writing. And, when we write technical documentation, we're also writing. The code we write now will be read by our future selves, future readers of our reports, and future users of our software tools. In writing our code today, we are writing the legacy code of tomorrow. And documentation is a user guide for the data infrastructures of the future. So, take care of these infrastructures, by writing good documentation! Please.
:::
